...
<!-- Mirrored from www.wrraptheme.com/templates/luno/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Jun 2023 07:36:24 GMT -->
        ...
        <div class="page-toolbar px-xl-4 px-sm-2 px-0 py-3">
            <div class="container-fluid">
                ...
                <div class="row align-items-center">
                    <div class="col">
                        {{-- <h1 class="fs-5 color-900 mt-1 mb-0">Welcome back, John!</h1>
                        <small class="text-muted">You have 7 new notificiations.</small> --}}
                    </div>
                    <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-7 col-sm-12 mt-2 mt-md-0">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn-secondary" type="button" data-bs-toggle="tooltip"
                                title="Send Report"><i class="fa fa-envelope"></i></button>
                            <button class="btn btn-secondary" type="button" data-bs-toggle="tooltip"
                                title="Download Reports"><i class="fa fa-download"></i></button>
                            <button class="btn btn-secondary" type="button" data-bs-toggle="tooltip"
                                title="Generate PDF"><i class="fa fa-file-pdf-o"></i></button>
                            <button class="btn btn-secondary" type="button" data-bs-toggle="tooltip"
                                title="Share Dashboard"><i class="fa fa-share-alt"></i></button>
                        </div>
                        <!-- Plugin Js -->
                    ...
                    <div class="tab-content">
                            ...
                            <div class="card mb-3">
                                ...
                                <ul class="list-group list-group-flush list-group-custom custom_scroll mb-0"
                                    ...
                                    <li class="list-group-item d-flex align-items-center">
                                        <img class="avatar rounded" src="{{ asset('assets/img/xs/avatar1.jpg') }}"
                                            alt="">
                                    ...
                                    <li class="list-group-item d-flex align-items-center">
                                        <img class="avatar rounded" src="{{ asset('assets/img/xs/avatar2.jpg') }}"
                                            alt="">
                                        <div class="flex-fill ms-2">
                                    ...
                                    <li class="list-group-item d-flex align-items-center">
                                        <img class="avatar rounded" src="{{ asset('assets/img/xs/avatar3.jpg') }}"
                                            alt="">
                                        <div class="flex-fill ms-2">
                                            <div class="h6 mb-0">Chris Fox</div>
                                    ...
                                    <li class="list-group-item d-flex align-items-center">
                                        <img class="avatar rounded" src="{{ asset('assets/img/xs/avatar4.jpg') }}"
                                            alt="">
                                        <div class="flex-fill ms-2">
                                            <div class="h6 mb-0">Chris Fox</div>
                                    ...
                                    <li class="list-group-item d-flex align-items-center">
                                        <img class="avatar rounded" src="{{ asset('assets/img/xs/avatar5.jpg') }}"
                                            alt="">
                                        <div class="flex-fill ms-2">
                                            <div class="h6 mb-0">Chris Fox</div>
                                    ...
                                    <li class="list-group-item d-flex align-items-center">
                                        <img class="avatar rounded" src="{{ asset('assets/img/xs/avatar6.jpg') }}"
                                            alt="">
                                        <div class="flex-fill ms-2">
                                            <div class="h6 mb-0">Chris Fox</div>
                                    ...
                                    <li class="list-group-item d-flex align-items-center">
                                        <img class="avatar rounded" src="{{ asset('assets/img/xs/avatar7.jpg') }}"
                                            alt="">
                                        <div class="flex-fill ms-2">
                                            <div class="h6 mb-0">Chris Fox</div>
                                    ...
                                    <li class="list-group-item d-flex align-items-center">
                                        <img class="avatar rounded" src="{{ asset('assets/img/xs/avatar8.jpg') }}"
                                            alt="">
                                        <div class="flex-fill ms-2">
                                            <div class="h6 mb-0">Chris Fox</div>
                        ...
                        <div class="tab-pane fade" id="step4">
                            <div class="card text-center">
                                ...
                                <div class="card-body">
                                    <img class="img-fluid" src="{{ asset('assets/img/project-team.svg') }}"
                                        alt="" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="ps-2">
                        ...
                        <div class="timeline-item ti-info p-3">
                            <div class="timeline-icon">
                                <img class="avatar sm rounded-circle" src="{{ asset('assets/img/xs/avatar1.jpg') }}"
                                    alt="">
                            </div>
                            <div class="timeline-content ms-3">
                ...
                <div class="d-flex align-items-start">
                    <div class="nav flex-column nav-pills p-3 h-100">
                        ...
                        <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
                            ...
                            <img class="avatar sm rounded-circle border"
                                src="{{ asset('assets/img/xs/avatar3.jpg') }}" alt="avatar">
                        </a>
                        <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
                            data-bs-target="#c-user-2" title="">
                            <img class="avatar sm rounded-circle border"
                                src="{{ asset('assets/img/xs/avatar4.jpg') }}" alt="avatar">
                        </a>
                        <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
                            data-bs-target="#c-user-5" title="">
                            <img class="avatar sm rounded-circle border"
                                src="{{ asset('assets/img/xs/avatar5.jpg') }}" alt="avatar">
                        </a>
                        <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
                            data-bs-target="#c-user-1" title="">
                            <img class="avatar sm rounded-circle border"
                                src="{{ asset('assets/img/xs/avatar6.jpg') }}" alt="avatar">
                        </a>
                        <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
                            data-bs-target="#c-user-7" title="">
                            <img class="avatar sm rounded-circle border"
                                src="{{ asset('assets/img/xs/avatar7.jpg') }}" alt="avatar">
                        </a>
                        <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
                            data-bs-target="#c-user-3" title="">
                            <img class="avatar sm rounded-circle border"
                                src="{{ asset('assets/img/xs/avatar8.jpg') }}" alt="avatar">
                        </a>
                        <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
                            data-bs-target="#c-user-3" title="">
                            <img class="avatar sm rounded-circle border"
                                src="{{ asset('assets/img/xs/avatar9.jpg') }}" alt="avatar">
                        </a>
                        <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
                            data-bs-target="#c-user-1" title="">
                            <img class="avatar sm rounded-circle border"
                                src="{{ asset('assets/img/xs/avatar10.jpg') }}" alt="avatar">
                        </a>
                        <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
                            data-bs-target="#c-user-1" title="">
                            <img class="avatar sm rounded-circle border"
                                            ...
                                            <div class="max-width-70">
                                                <div class="user-info mb-1">
                                                    <img class="avatar xs rounded-circle me-1"
                                                        src="{{ asset('assets/img/xs/avatar1.jpg') }}"
                                                        alt="avatar">
                                    ...
                                    <ul class="list-unstyled chat-history flex-grow-1">
                                        ...
                                        <li class="mb-3 d-flex flex-row align-items-end">
                                            <div class="max-width-70">
                                                <div class="user-info mb-1">
                                                    <img class="avatar xs rounded-circle me-1"
                                                        src="{{ asset('assets/img/xs/avatar2.jpg') }}"
                                                        alt="avatar">
                                                    <span class="text-muted small">10:10 AM, Today</span>
                                                </div>
                                                <div class="card p-3">
                                ...
                                <div class="bg-images">
                                    <ul class="list-unstyled d-flex">
                                        ...
                                        <li class="sidebar-img-2 me-1"><a class="rounded sidebar-img"
                                                id="img-2" href="#"><img
                                                    src="{{ asset('assets/img/sidebar-bg/sidebar-2.jpg') }}"
                                                    alt="" /></a></li>
                                        <li class="sidebar-img-3 me-1"><a class="rounded sidebar-img"
                                                id="img-3" href="#"><img
                                                    src="{{ asset('assets/img/sidebar-bg/sidebar-3.jpg') }}"
                                                    alt="" /></a></li>
                                        <li class="sidebar-img-4 me-1"><a class="rounded sidebar-img"
                                                id="img-4" href="#"><img
                                                    src="{{ asset('assets/img/sidebar-bg/sidebar-4.jpg') }}"
                                                    alt="" /></a></li>
                                        <li class="sidebar-img-5 me-1"><a class="rounded sidebar-img"
                                                id="img-5" href="#"><img
                                                    src="{{ asset('assets/img/sidebar-bg/sidebar-5.jpg') }}"
                                                    alt="" /></a></li>
                                    </ul>
                                </div>
                            </li>
...
<!-- Mirrored from www.wrraptheme.com/templates/luno/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Jun 2023 07:36:42 GMT -->
