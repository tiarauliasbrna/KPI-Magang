...
@section('content')
    ...
    <head>
        ...
        <title>:: LUNO :: CRM Analytics</title>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <div>
                                        <h6 class="card-title mb-0">Overall KPI Summary Graph - 2023
                                    </div>
    ...
    <!-- Mirrored from www.wrraptheme.com/templates/luno/crm/analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Jun 2023 07:46:51 GMT -->
